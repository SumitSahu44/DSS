...
const AddBlog = () => {
  ...
  return (
    <div style={{ padding: "40px", maxWidth: "800px", margin: "100px auto", fontFamily: "Arial, sans-serif", backgroundColor: "#f9f9f9", borderRadius: "10px", boxShadow: "0 4px 6px rgba(0,0,0,0.1)" }}>
